...
{
    public class FormMembershipPerson : BaseForm<FormMembershipPerson>, IToNode
    {
        ...
        public EPersonRelated? Related { get; set; }
        ...
        public override void Import(CNode node)
        {
            ...
            //Related = node.TryGetEnum<EPersonRelated>("related");
